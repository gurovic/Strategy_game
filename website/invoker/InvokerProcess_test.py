...
from invoker.InvokerProcess import InvokerProcess
import typing
...
class TestInvokerProcess(TestCase):
    ...
    @patch("invoker.InvokerProcess_test.TestInvokerProcess.InvokerProcessForTesting.kill")
    @patch("invoker.InvokerProcess_test.TestInvokerProcess.InvokerProcessForTesting.make_run_result")
    @patch("invoker.InvokerProcess_test.TestInvokerProcess.InvokerProcessForTesting.wait")
