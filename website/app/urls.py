...
from .views import sandbox_views, tournament_views, tournament_start_view, tournament_register_views, tournament_results_view
...
urlpatterns = [
    ...
    path('tournament<int:tournament_id>/results', tournament_results_view.start_page)
]
