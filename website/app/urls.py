...
from .views import sandbox_views, tournament_views, tournament_start_view, tournament_register_views, game_upload_views
...
urlpatterns = [
    ...
    path('game_upload/', game_upload_views.GameUploadView.as_view(), name='game_upload'),
]
