...
class Game(models.Model):
    ...
    play = models.FileField(upload_to=user_directory_path, max_length=1000, null=True, verbose_name='Play')
    compiled_play = models.FileField(upload_to=user_directory_path, null=True, verbose_name='Compiled play')
