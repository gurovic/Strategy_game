...
export class OurTeamService {
  public members: Member[] = [
    ...
    {name: 'Maria Bessolova', image_path: 'assets/our_team_photos/boris.png', position: 'Backend dev' },
    ...
    {name: 'Alexandra ...', image_path: 'assets/our_team_photos/boris.png', position: 'Thinker' },
  ]
